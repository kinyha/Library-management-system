...
public class BooksController {
    ...
    public String show(@ModelAttribute("person") Person person,
                       ...
                       @PathVariable("id") int bookId, Model model) {
        model.addAttribute("book", booksService.findOne(bookId));
        model.addAttribute("comments", booksService.getComments(bookId));
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        System.out.println(auth.getName());
        model.addAttribute("personAuth", peopleService.getPersonByName(auth.getName()));
